use crate::{ai_functions::aifunc_architect::print_project_scope, helpers::general::ai_task_request_decoded, models::{agent_basic::{basic_agent::{AgentState, BasicAgent}, basic_traits::BasicTraits}, agents::traits::{FactSheet, ProjectScope}}};
